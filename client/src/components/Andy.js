    ...
    return (
      <div className="maincontainer">
        ...
        <div className="reviewButtonContainer d-flex flex-column justify-content-between">
          ...
          <div className="p2">
            <a href="https://www.zillow.com/reviews/write/?s=X1-ZUz7w40pq8jcax_4lr3f" target="_blank">
              <img width="300px" src="https://zillow.mediaroom.com/download/Zillow_Wordmark_Blue_RGB+lrg.png" />
            </a>
          </div>
          <div className="p2">
            <a href="https://www.realtor.com/realestateagents/indalecio-del-real_modesto_ca_1680134_681144528#" target="_blank">
