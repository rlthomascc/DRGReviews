    ...
    return (
      <div className="maincontainer">
        ...
        <div className="reviewButtonContainer d-flex flex-column justify-content-between">
          ...
          <div className="p2">
            <a href="https://www.zillow.com/reviews/write/?s=X1-ZU15s76gbjsc0eh_3fm19" target="_blank">
              <img width="300px" src="https://zillow.mediaroom.com/download/Zillow_Wordmark_Blue_RGB+lrg.png" />
            </a>
          </div>
          <div className="p2">
            <a href="https://www.realtor.com/realestateagents/622cb0ca19e63b5aecf1cffe" target="_blank">
