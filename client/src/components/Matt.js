    ...
    return (
      <div className="maincontainer">
        ...
        <div className="reviewButtonContainer d-flex flex-column justify-content-between">
          ...
          <div className="p2">
            <a href="https://www.zillow.com/reviews/write/?s=X1-ZU14q6d6zu6zle1_55f21" target="_blank">
              <img width="300px" src="https://zillow.mediaroom.com/download/Zillow_Wordmark_Blue_RGB+lrg.png" />
            </a>
          </div>
          <div className="p2">
            <a href="https://www.realtor.com/realestateagents/matthew-d.-foster_modesto_ca_4243855_779834528" target="_blank">
