...
class Jennapher extends Component {
  constructor(props) {
    super(props);
    this.state = {
      description: '',
    ...
    return (
      <div className="maincontainer">
        ...
        <div className="reviewButtonContainer d-flex flex-column justify-content-between">
          ...
          <div className="p2">
            <a href="https://www.zillow.com/reviews/write/?s=X1-ZUx3uwud1hvfgp_a1052" target="_blank">
              <img width="300px" src="https://zillow.mediaroom.com/download/Zillow_Wordmark_Blue_RGB+lrg.png" />
            </a>
          </div>
          {/* <div className="p2">
            <a href="https://www.realtor.com/realestateagents/don-wright,-crs_modesto_ca_2990901_762044528#" target="_blank">
