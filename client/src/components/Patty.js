    ...
    return (
      <div className="maincontainer">
        ...
        <div className="reviewButtonContainer d-flex flex-column justify-content-between">
          ...
          <div className="p2">
            <a href="https://www.zillow.com/reviews/write/?s=X1-ZUxlg6yk8n2cy1_9hc6g" target="_blank">
              <img width="300px" src="https://zillow.mediaroom.com/download/Zillow_Wordmark_Blue_RGB+lrg.png" />
            </a>
          </div>
          <div className="p2">
            <a href="https://www.realtor.com/realestateagents/patricia-j-servin-martinez_modesto_ca_1701041_001934528" target="_blank">
