        ...
        <div>
          ...
          <div>
            <Route
              ...
              strict
              render={() => (
                <Jennapher changeAddress={this.changeAddress.bind(this)} />
              )}
            />
          </div>
          <div>
            <Route
              ...
              strict
              render={() => (
                <Jared changeAddress={this.changeAddress.bind(this)} />
              )}
            />
          </div>
          <div>
          ...
          <div>
            <Route
              ...
              strict
              render={() => (
                <Luke changeAddress={this.changeAddress.bind(this)} />
              )}
            />
          </div>
          <div>
            <Route
              ...
              strict
              render={() => (
                <Amy changeAddress={this.changeAddress.bind(this)} />
              )}
            />
          </div>
        </div>
